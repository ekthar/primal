...
export const AGE_GROUPS = [
  { id: "kids-2018-2019", label: "Kids 2018-2019", minBirthYear: 2018, maxBirthYear: 2019, minAge: 6, maxAge: 8 },
  { id: "kids-2016-2017", label: "Kids 2016-2017", minBirthYear: 2016, maxBirthYear: 2017, minAge: 8, maxAge: 10 },
  { id: "under-12", label: "Under 12", minBirthYear: 2014, maxBirthYear: 2015, minAge: 10, maxAge: 12 },
  { id: "under-14", label: "Under 14", minBirthYear: 2012, maxBirthYear: 2013, minAge: 12, maxAge: 14 },
  { id: "under-16", label: "Under 16", minBirthYear: 2010, maxBirthYear: 2011, minAge: 14, maxAge: 16 },
  { id: "under-18", label: "Under 18", minBirthYear: 2008, maxBirthYear: 2009, minAge: 16, maxAge: 18 },
...
export const OFFICIAL_WEIGHT_CLASS_TABLE = {
  "under-12": [
...
export function calculateAge(dateOfBirth, onDate) {
...
export function getDisciplineById(disciplineId) {
  return DISCIPLINE_DEFINITIONS.find((discipline) => discipline.id === disciplineId) || null;
}

export function resolveOfficialDivision(input) {
...
export function getAllowedDisciplinesForDivision(divisionId) {
  return AGE_DISCIPLINES[divisionId] || [];
}

export function getWeightClassForDivision(divisionId, weightKg) {
...
export function buildOfficialCategory(input) {
...
export function deriveOfficialWeightClass(input) {
